...
public static class LeanTweenExt
{
    ...
    public static LTDescr LeanBlur(this GameObject gameObject, float to, float time) { return LeanTween.blur(gameObject, to, time); }
    ...
    //LeanTween.alphaText
    public static LTDescr LeanAlphaImage(this RectTransform rectTransform, float to, float time) { return LeanTween.alphaImage(rectTransform, to, time); }
    ...
    public static LTDescr LeanColor(this RectTransform rect, Color to, float time) { return LeanTween.color(rect, to, time); }
    public static LTDescr LeanColorMaterial(this GameObject gameObject, Color to, float time) { return LeanTween.colorMaterial(gameObject, to, time); }
    public static LTDescr LeanColorParticle(this GameObject gameObject, Color to, float time) { return LeanTween.colorParticle(gameObject, to, time); }
    //LeanTween.colorText
    ...
    //LeanTween.scale
    public static LTDescr LeanLayoutElementScale(this GameObject gameObject, float to, float time) { return LeanTween.layoutScale(gameObject, to, time); }
